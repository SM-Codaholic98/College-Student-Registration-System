...
app = Flask(__name__)
app.secret_key = "AU_Sem04_Project"
...
def write_csv(students):
    with open(CSV_FILE, 'w', newline='') as file:
        columns = ['Stu_ID', 'Stu_FullName', 'Age', 'Stu_ContactNo', 'Stu_Email', 'Address', 'Department', 'Specialization', 'School', 'Program_Year', 'Father_Name', 'Mother_Name', 'P_ContactNo', 'P_Email']
...
def login():
    if request.method == 'POST':
        ...
        if username == '123' and password == '123':
            ...
            return render_template('login.html', message='Invalid Credentials. Please try again  __/\__')
